    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="stat-card">
                        <img src="https://media.istockphoto.com/id/1017466322/vector/target-audience-customer-client-targeting-consumer-centricity-aim-people-sign.jpg?s=612x612&w=0&k=20&c=E5iUfNUeU0wYtJfY6fBOtUQPaNhcAccWFmeuobl15qE=" alt="Major Image" style="width: 50px; height: 50px;">
                        <h3>Customer</h3>
                        <a href="CustomerManagerServlet" class="btn btn-warning">Manage Customer</a>
                    </div>
                </div>
            </div>

        ...
        <div class="container mt-5">
            ...
            <form id="addProductForm" action="AddServiceServlet" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="category_name" name="category_name" value="${service.category.category_name}" required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="brief_infor" name="brief_infor" rows="2">${service.thumbnail}</textarea>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="date_add" name="date_add" value="${service.date_add}">
                </div>
                <div class="mb-3">
                    <label for="create_date" class="form-label">Create Date</label>
                    <input type="text" class="form-control" id="create_date" name="create_date" value="${service.create_date}">
                </div>

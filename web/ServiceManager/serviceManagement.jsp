                ...
                <tbody>
                    <c:forEach var="service" items="${service}">
                        <tr>
                            ...
                            <td>
                                <a href="editService?id=${service.service_id}" class="btn btn-edit btn-sm">
                                    <i class="fas fa-edit"></i> 
                                </a>
                                <a href="updateService?id=${service.service_id}" class="btn btn-update btn-sm">
                                    <i class="fas fa-sync"></i> 
                                </a>
                                <a href="deleteService?id=${service.service_id}" class="btn btn-delete btn-sm">

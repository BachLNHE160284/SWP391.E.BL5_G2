 ...
 * @author Admin
 */
@WebServlet(name = "CheckCodeRegister", urlPatterns = {"/checkCodeRegister"})
public class CheckCodeRegister extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet CheckCodeRegister</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet CheckCodeRegister at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (!code.equals(confirmationCode)) {
            ...
            userDAO.registerCustomer(fullname, gender, email,password);
